...
$query = "SELECT * FROM user a, foto b where a.id=b.id ORDER BY b.id DESC";
$result = mysqli_query($connect, $query);
 ?>

<a href="<?= $WEB_CONFIG['base_url'] ?>tambah_mahasiswa" class="btn btn-primary mb-3">
    ...
    </svg> Tambah  Data Mahasiswa Baru
</a>
<div class="box_table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= $WEB_CONFIG['base_url'] ?>update_mahasiswa-<?= $data['id'] ?>" class="btn btn-success m-1">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>apakah yakin ingin mengapus data? </p>
      </div>
